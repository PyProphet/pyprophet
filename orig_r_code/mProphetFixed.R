...
print(typeof(t.options))
print(t.options)

t.options <- c()
t.options["bin_dir"]="."
t.options["data_file"]="testdata_times_4.tsv"
t.options["data_file"]="test_reduced.txt"
t.options["num_xval"]="1"
t.options["plot_png"]="FALSE"
t.options["run_log"]="TRUE"
t.options["use_classifier"]=NA
t.options["write_classifier"]="FALSE"
t.options["write_all_classifiers"]="FALSE"
t.options["write_all_pg"]="TRUE"
t.options["working_dir"]=NA
t.options["project"]=NA
t.options["workflow"]="SPIKE_IN"
t.options["plot_pvalue_hist"]="FALSE"
t.options["plot_xval_hist"]="FALSE"
t.options["plot_roc"]="FALSE"
t.options["plot_separate"]="FALSE"
t.options["debug_on"]="FALSE"
t.options["file_dialogue"]="FALSE"
t.options["minimal_top_pg"]="FALSE"
t.options["write_xval_table"]="FALSE"
